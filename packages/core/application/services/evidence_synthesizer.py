...
def _build_system_prompt(response_language: str) -> str:
    ...
    return (
        ...
        "inventing one, or note the missing figure in evidence_gaps. Never derive a "
        "number for a GROUP or multiple individuals by simply multiplying a "
        "per-individual figure from the Evidence by a count given in the case — real "
